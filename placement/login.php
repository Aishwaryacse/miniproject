...
<head>
    ...
    <style>
        ...
        .container {
            ...
            text-align: center;
            margin: 20px 0; /* Add space between containers */
        }
        h1 {
...
<body>
    ...
    <div class="container">
        <h1>Admin Login</h1>
        <form method="post" action="admin.php"> <!-- Update the action URL for admin login -->
            <input type="hidden" name="login_type" value="admin"> <!-- Hidden field to specify admin login -->
